...
The customisation of programs developed with the FireMonkey framework in Delphi is very powerful but is not always easy to set up when you want to allow end users to choose a style or if you want to support the light and dark modes of operating systems.

This code repository contains classes to simplify things a little. You'll find a container ancestor for adding your styles to your FireMonkey projects and a style referencing and activation system so that it all happens almost automatically. With this system, only the active style is loaded into memory; the others ‘sleep’ in the program's resources.
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/FMX-Styles-Utils).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/FMX-Styles-Utils) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://fmxstylesutils.developpeur-pascal.fr/) or [the project devlog](https://developpeur-pascal.fr/fmx-styles-utils.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/FMX-Styles-Utils/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://fmxstylesutils.developpeur-pascal.fr/).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/FMX-Styles-Utils) and [open a new issue](https://github.com/DeveloppeurPascal/FMX-Styles-Utils/issues).
